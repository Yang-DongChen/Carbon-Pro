...
.menu-item.active { background: #1890ff; color: white; border-right: 4px solid #1890ff; }
...
.top-bar { height: 64px; background: white; padding: 0 24px; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 1px 4px rgba(0,21,41,0.08); }
...
.card-header { margin-bottom: 20px; border-bottom: 1px solid #f0f0f0; padding-bottom: 10px; font-weight: bold; }
.control-item { display: flex; align-items: center; justify-content: space-between; background: #fafafa; padding: 16px; border-radius: 6px; border: 1px solid #eee; }
.control-info .label { display: block; font-weight: 600; color: #333; }
.control-info .desc { margin: 0; color: #999; font-size: 13px; }
</style>